...
<?php
       include 'includes/sous_menus_admin.php';
        ?>
          ...
          <form method="POST" enctype="multipart/form-data" id="myform"action="<?=base_url().'Admin/update/'?><?=$user['USER_ID']?>">
      ...
      <label>Nom </label>
      <input type="text" class="form-control" name="NOM" value="<?=$user['NOM_USER']?>" autofocus>
       ...
       <div class="col-md-4 col-sm-12 col-xs-12">
      <label>Prénom </label>
      <input type="text" class="form-control" name="PRENOM" value="<?=$user['PRENOM_USER']?>" autofocus>
      ...
      <input type="number" class="form-control" name="TELEPHONE" value="<?=$user['TELEPHONE']?>" autofocus>
      ...
      <input type="text" class="form-control" name="EMAIL" value="<?=$user['EMAIL']?>" autofocus>
       <font color='red'><?php echo form_error('EMAIL'); ?></font>
                  ...
                  <input type="password" class="form-control" name="PWD" value="<?=$user['PASSWORD']?>" autofocus>
