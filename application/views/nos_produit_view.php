	...
	<body  style=" background: #c9dbe9">
       ...
       include 'includes/my_header.php';
		...
		<div class="row" style="min-height: 10px;margin-bottom: 20px">
			<h4 class="text-uppercase" id="" style="text-align: ;">Nos categories</h4>


			<p class="sous_titre1" style="font-size: 18px;">Clickez sur une catégorie pour voir les produits correspondants:</p>
...
<div class="container" id="nos_prod" style="margin-top: 10px">
 ...
 <?php
						...
						?>
<p><a class="primary-btn" href="<?=base_url("Commande/passer_commande")?>" style="font-size: 20px;width: 100%">Passez votre commande</a>
	<?php }else{ ?>
 <p><a class="primary-btn" data-toggle="modal" data-target="#so"  style="font-size: 20px;width: 100%">Passez votre commande</a>
 	<?php } ?>
</div>
...
<script type="text/javascript">
	...
	var readMoreHtml=$(this).html();
      var lessText=readMoreHtml.substr(0,20);

      if(readMoreHtml.length >20){
...
<script type="text/javascript">
    ...
    $.ajax({
                            url:"<?php echo base_url() ?>Nos_produits/produit",
                            method:"POST",
                            //async:false,
                            data: {id:id},
