    ...
    <div class="row">
     ...
     <?php
       include 'includes/sous_menus_admin.php';
        ...
        <?php
$point1=$this->Model->getRequeteOne("SELECT  IFNULL(SUM(MONTANT_CLIENT),0) as n from commande where STATUT=0");
        ?>
 <span style='font-size: 20px'>TOTAL GENERAL : <b><?=number_format($point1['n'], 0, ',', ' ')?></b></span><br>
 <p></p>
...
<script>
       ...
       responsive: true,
         buttons: [
                ...
                {extend: 'excel', title: "LISTE DES NOUVELLES COMMANDES DU <?=date('d/m/Y')?>"},
                {exportOptions: {
