       ...
       include 'includes/sous_menus_admin.php';
        ?>
            <div class="col-md-12" style="margin-top: 50px">
                <h3 style="text-align: center;">Historique de Réquisitions</h3>
                 
                     <?=$breadcrumb?>

                     <div class="row">
                        <form id="myform" name="myform" action="<?php echo base_url()?>Admin/requisition_historique"  method="post" enctype="multipart/form-data">
